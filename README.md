...
> * Числа отражают уровень важности.
> * Запрещается использовать словесные названия.


### Директории
Все директории в проектах, именуются с префикса `N` *(от лат. **Node** — «галстук»)* и числового идентификатора уровня вложенности.

Директория рассматривается как структурный узел, определяющий место поддиректорий в иерархии проекта. Идентификатор директории отражает уровень вложенности.
Таким образом, по имени директории сразу видно её положение в структуре проекта, даже без просмотра дерева.
...
> * Числа отражают уровень иерархии.
...
> * Числа отражают порядок добавления.
