...
| Тип объекта                 | Префикс | Идентификатор | Пример                              |
| --------------------------- | -----   | ------------- | ------------------------------------------------------------------------------ |
| Проект                      | `NNN`   | Приоритет     | Идентификатор проекта отражает приоритет: `NNN1`, `NNN2`, …                     |
| Директория                  | `N`     | Вложенность   | Суффикс показывает уровень вложенности: `N1/`, `N2/`, … Вложенные: `N1_1/`, …                               |
| Файл                        | `n`     | Добавление    | Идентификатор — порядковый номер: `n1.py`, `n2.py`, …                                               |
| Переменная                  | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n238458672`, `n837465920`, …                                        |
| Булевая переменная          | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n238458672`, `n837465920`, …                                        |
| Константы                   | `—`     | —             | Числа: `1`, `2`, `3`, …                                                      |
| Функция                     | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n_238458672(_n)`, `n_73078472800(_n, _nn)`, …                                               |
| Логическая функция          | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n_238458672(_n)`, `n_73078472800(_n, _nn)`, …                                               |
| Класс                       | `N`     |               | Идентификатор определяется утилитой `Nn1`: `N2384586729`, дочерние: `Nn7649280294`                               |
| Публичное поле              | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n928374651`, приватные: `_n928374651`                                  |
| Публичное булевое поле      | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n928374651`, приватные: `_n928374651`                                  |
| Приватное поле              | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n928374651`, приватные: `_n928374651`                                  |
| Приватное булевое поле      | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n928374651`, приватные: `_n928374651`                                  |
| Публичный метод             | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n_238458672()`, логические: `n01010101()`, приватные: `_n856394750()`|
| Приватное метод             | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n_238458672()`, логические: `n01010101()`, приватные: `_n856394750()`|
| Алиас для библиотеки        | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n_238458672()`, логические: `n01010101()`, приватные: `_n856394750()`|
| Алиас для классов           | `n`     |               | Идентификатор определяется утилитой `Nn1`: `n_238458672()`, логические: `n01010101()`, приватные: `_n856394750()`|
